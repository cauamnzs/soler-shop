...
export const computeCompoundInstallment = (base: number, months: number): number => {
  ...
  if (n <= 1) return base;
  const factor = Math.pow(1 + INTEREST_RATE_PER_MONTH, n);
  return base * factor;
};
...
export const PRODUCT_SOURCE_OF_TRUTH: ServerProduct[] = [
  { id: "SOL-001", name: "Perfume Xerjoff Velvet",         price: "R$ 489,00", image: "/placeholder.svg" },
  { id: "SOL-002", name: "Esfoliante Peppermint Pearl",     price: "R$ 129,00", image: "/placeholder.svg" },
  { id: "SOL-003", name: "Brincos Solar Soler",              price: "R$ 89,00",  image: "/placeholder.svg" },
  { id: "SOL-004", name: "Gloss Pink Mimosa",                price: "R$ 69,00",  image: "/placeholder.svg" },
  { id: "SOL-005", name: "Hidratante Corporal Rose Silk",    price: "R$ 159,00", image: "/placeholder.svg" },
  { id: "SOL-006", name: "Kit Presente Fragrâncias",         price: "R$ 699,00", image: "/placeholder.svg" },
  { id: "SOL-007", name: "Body Mist Super Berry",            price: "R$ 79,00",  image: "/placeholder.svg" },
  { id: "SOL-008", name: "Kit Body Mists Pink",              price: "R$ 259,00", image: "/placeholder.svg" },
  { id: "SOL-009", name: "Body Mist Rich Honey",             price: "R$ 79,00",  image: "/placeholder.svg" },
];
...
export const computeServerTotals = (req: CheckoutRequest): ServerTotals => {
  const lookup: Record<string, ServerProduct> = {};
