...
const FluidBackground = () => {
  ...
  return (
    <div className="fixed inset-0 z-[-10] bg-background pointer-events-none overflow-hidden h-[100dvh] w-full">
      ...
      {/* Ruído de Filme sutil — quase invisível no dark */}
      <div 
        className="absolute -inset-[300px] opacity-[0.02] md:opacity-[0.03] dark:opacity-[0.008] mix-blend-multiply dark:mix-blend-soft-light pointer-events-none"
        style={{
